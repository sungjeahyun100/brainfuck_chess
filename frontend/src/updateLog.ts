...
export const updateLog: readonly UpdateLogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      '마법사 나이트에는 말머리 실루엣과 별빛 눈, 마법사 비숍에는 대각선 장식과 별 문양을 더한 전용 백·흑 기물 디자인을 적용했습니다.',
      '두 디자인 모두 기존 마법사 계열과 같은 초승달 형태의 바디와 검정·하얀 배색을 사용해 보드에서 같은 계열로 구분됩니다.',
    ],
  },
  {
    id: '2026-09-20.1',
    date: '2026-09-20',
    title: '마법사 나이트와 마법사 비숍 추가',
    changes: [
      '마법사 나이트와 마법사 비숍을 각각 3점 뒷줄 기물로 추가했습니다. 기본 행마는 일반 나이트와 비숍과 같고, 마법사 생도가 두 기물로도 승급할 수 있습니다.',
      '마법사 나이트는 보드 내부의 모든 나이트 목적지가 마법사 계열로 채워지면, 퀸의 8방향에서 빈칸을 지나 처음 만나는 적만 포획할 수 있습니다.',
      '마법사 비숍은 바로 상하좌우가 모두 마법사 생도일 때, 대각선에서 처음 만나는 기물의 편을 구분하지 않고 넘어 바로 뒤의 적을 포획할 수 있습니다.',
    ],
  },
  {
    id: '2026-09-16.4',
