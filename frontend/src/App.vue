...
const pieceCatalog: PieceCatalogItem[] = [
  ...
  { id: 'tempest-pawn', name: 'Tempest Pawn', score: 1, category: 'pawn', canPocket: true, aliases: ['템페스트 폰', 'storm pawn'] },
...
const pieceMoveDescriptions: Record<string, string> = {
  ...
  'tempest-knight': 'Tempest Knight: 대각선으로 한 칸 이동한 뒤 Knight 궤적으로 이어가고, 직선으로 세 칸 이동합니다.',
  'bouncing-bishop': 'Bouncing Bishop: 대각선으로 이동하나 벽에 닿을 시 한 번 튕깁니다.',
  'tempest-pawn': 'Tempest Pawn: Pawn처럼 이동하고, Tempest 계열 기물로만 프로모션합니다.',
