BEGIN;
SELECT pg_advisory_xact_lock(hashtextextended('deck-chess-prod-analysis-draws-v1', 0));
...
ALTER TABLE prod.game_analysis_nodes ADD COLUMN IF NOT EXISTS draws JSONB NOT NULL DEFAULT '[]'::jsonb CHECK (jsonb_typeof(draws) = 'array');
RESET ROLE;
