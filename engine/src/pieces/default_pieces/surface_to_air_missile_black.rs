...
use super::surface_to_air_missile_white::INTERCEPT_ABILITY_ID;

/// Black Surface-to-Air Missile: mirror of the White piece.
pub fn surface_to_air_missile_black_definition() -> PieceDefinition {
    let movement = "\
take-move(1, -1);
...
take-move(-1, -1);"
        .to_string();
    PieceDefinition {
        id: "surface-to-air-missile-black".into(),
        name: "지대공 미사일".into(),
        score: 2,
        max_ammo: 2,
    ...
    .expect("black surface-to-air missile definition must be valid")
}
