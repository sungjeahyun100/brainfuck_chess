...
/// Bouncing Rook: follows ranks and files, then turns in either perpendicular
/// direction when it reaches a board edge.
...
pub fn bouncing_queen_definition() -> PieceDefinition {
    legacy_piece_definition! {
        ...
        score: 13,
        chessembly_code: format!(
            "{}\n{}",
            bouncing_bishop_chessembly_code(),
            bouncing_rook_chessembly_code()
        ),
        chessembly_version: "1.0".into(),
        dialect: None,
        extensions: None,
